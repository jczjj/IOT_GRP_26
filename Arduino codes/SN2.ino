...
static const u1_t PROGMEM DEVEUI[8] = { 0x68, 0x60, 0x07, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
void os_getDevEui(u1_t* buf) { memcpy_P(buf, DEVEUI, 8); }

static const u1_t PROGMEM APPKEY[16] = {
  0x32, 0x5B, 0x29, 0x12, 0x2D, 0x82, 0x18, 0xAB,
  0xDE, 0x0C, 0x13, 0x30, 0x3B, 0xFA, 0xA7, 0x7B
};

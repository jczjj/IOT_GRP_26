...
static const u1_t PROGMEM DEVEUI[8] = { 0x75, 0x5D, 0x07, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 };
void os_getDevEui(u1_t* buf) { memcpy_P(buf, DEVEUI, 8); }

static const u1_t PROGMEM APPKEY[16] = {
  0x48, 0xE3, 0xC6, 0xE4, 0x30, 0x90, 0x3F, 0xAD,
  0xB9, 0xDA, 0x4E, 0x71, 0x26, 0x61, 0x7F, 0xB8
};
